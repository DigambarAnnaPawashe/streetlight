...
<html>
<head>
  	<title>User threephase Y onoff</title>
    <meta charset="utf-8">
...
String sql="Update threephase set y_onoff=? where dpid="+id;
...
if(i > 0)
{
    ...
    RequestDispatcher rd=request.getRequestDispatcher("onoffdetail_user.jsp?admin_phone="+admin_phone);

...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="#"><span class="fa fa-users"></span> Admin Manager</a>
          </li>
          <li>
            <a href="#"><span class="fa fa-users"></span> User Manager</a>
          </li>
          <li>
            <a href="#"><span class="fa fa-bell"></span> Admin Notifications</a>
          </li>
           <li>
            <a href="#"><span class="fa fa-bell"></span> User Notifications</a>
          </li>
           <li>
            <a href="#"><span class="fa fa-toggle-on"></span>ON/OFF</a>
          </li>
           <li>

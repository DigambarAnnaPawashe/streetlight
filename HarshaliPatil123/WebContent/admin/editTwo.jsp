		...
		<nav id="sidebar" class="active">
			...
			<ul class="list-unstyled components mb-5">
				<li class="active"><a href="#"><span class="fa fa-home"></span>
						DashBoard</a></li>
				<li><a href="dptable.jsp"><span class="fa fa-sliders"></span>
						DP List</a></li>
				<li><a href="#"><span class="fa fa-users"></span> Admin
						Manager</a></li>
				<li><a href="#"><span class="fa fa-users"></span> User
						Manager</a></li>
				<li><a href="#"><span class="fa fa-bell"></span> Admin
						Notifications</a></li>
				<li><a href="#"><span class="fa fa-bell"></span> User
						Notifications</a></li>
				<li><a href="#"><span class="fa fa-toggle-on"></span>ON/OFF</a>
				</li>
				<li><a href="#"><span class="fa fa-power-off"></span>Logout</a>
				</li>
			</ul>

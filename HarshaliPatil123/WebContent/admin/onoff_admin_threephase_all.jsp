...
<head>
<meta charset="UTF-8">
	<title>Admin_threephase all onoff</title>
    <meta charset="utf-8">
...
String sql="Update threephase set r_onoff=?,y_onoff=?,b_onoff=? where dpid="+id;
...
if(i > 0)
{
	RequestDispatcher rd=request.getRequestDispatcher("onoff_admin.jsp?admin_phone="+admin_phone);

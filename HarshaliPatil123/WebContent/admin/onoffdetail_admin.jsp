       ...
       <div class="card-body">
         ...
         %>
            <img class="card-img-top" src="../images/ONbulb.jpg" alt="Card image cap"><br><br>
             <form action="onoff_admin_onephase.jsp?admin_phone=<%=admin_phone%>" method="post">
...
<div class="card" style="width: 17rem; ">
 ...
 %>
     <img class="card-img-top" src="../images/ONbulb.jpg" alt="Card image cap"><br><br>
    <form action="onoff_admin_twophase_r.jsp?admin_phone=<%=admin_phone%>" method="post"> 
      <input type="hidden" name="dpid" value="<%=resultSet.getString("dpid")%>">
      <input type="hidden" name="data" value="#R0" >
     <button type="submit" class="btn btn-primary b">OFF</button>  
    </form>       
...
<div class="card" style="width: 17rem;">
  ...
  %>    
   <img class="card-img-top" src="../images/ONbulb.jpg" alt="Card image cap"><br><br>
   <form action="onoff_admin_twophase_y.jsp?admin_phone=<%=admin_phone%>" method="post">
   <input type="hidden" name="dpid" value="<%=resultSet.getString("dpid")%>">
...
<div class="card" style="width: 17rem;">
 ...
 <%
  ...
  %>
   <img class="card-img-top" src="../images/ONbulb.jpg" alt="Card image cap"><br><br>
   <form action="onoff_admin_threephase_r.jsp?admin_phone=<%=admin_phone%>" method="post">
    <input type="hidden" name="dpid" value="<%=resultSet.getString("dpid")%>">
    <input type="hidden" name="data" value="#R0" >
    <button type="submit" class="btn btn-primary b">OFF</button>  
   </form>    
...
<%
 ...
 %>
    <img class="card-img-top" src="../images/ONbulb.jpg" alt="Card image cap"><br><br>
  <form action="onoff_admin_threephase_y.jsp?admin_phone=<%=admin_phone%>" method="post">
   <input type="hidden" name="dpid" value="<%=resultSet.getString("dpid")%>">
   <input type="hidden" name="data" value="Y0" >   
  <button type="submit" class="btn btn-primary b">OFF</button> 
  </form>   
 ...
 <%
  ...
  %>
     <img class="card-img-top" src="../images/ONbulb.jpg" alt="Card image cap"><br><br>
     <form action="onoff_admin_threephase_b.jsp?admin_phone=<%=admin_phone%>" method="post">
     <input type="hidden" name="dpid" value="<%=resultSet.getString("dpid")%>">

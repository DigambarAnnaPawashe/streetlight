...
<html>
  <head>
  	<title>Twophase all onoff data send</title>
    <meta charset="utf-8">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid">
            ...
            <button type="button" id="sidebarCollapse" class="btn btn-primary">
             ...
             <button type="button" name="B1" id="B1" value="ON" class="HeaderButtons;btn btn-primary" style="width: 50px; background-color: white;color:black;" onclick="setButton(this.id); window.location.href=window.location.href">&nbsp;ON</button>        
            <button type="button" name="B2" id="B2" value="OFF" class="HeaderButtons;btn btn-primary" style="width: 50px; background-color: white;color:black;" onclick="setButton(this.id.disabled=true); window.location.href=window.location.href">&nbsp;OFF</button>        
...
if(i > 0)
{
	RequestDispatcher rd = request.getRequestDispatcher("onoffdetail.jsp?dpid="+id);

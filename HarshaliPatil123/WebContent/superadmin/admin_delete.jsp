...
<meta charset="UTF-8">
	...
	<title>Delete Admin Record</title>
...
<div class="my" >
   ...
   <div class="form-group">
    <label for="exampleInputEmail1">Name::</label>
     <input type="text" class="form-control" id="u_name" name="admin_name"  value="<%=resultSet.getString("admin_name")%>" disabled="disabled"/>
  </div>
	
	<div class="form-group">
    <label for="exampleInputPassword1">Email::</label>
     <input type="text" class="form-control" id="e_mail" name="admin_email"  value="<%=resultSet.getString("admin_email")%>" disabled="disabled"/>
  </div>
	
	<div class="form-group">
    <label for="exampleInputPassword1" for="inputSmall">Mobile::</label>
     <input  type="text"  class="form-control" id="p_hone" name="admin_phone" value="<%=resultSet.getString("admin_phone")%>" disabled="disabled"/>
 	 ...
 	 <div class="form-group">
     <label for="exampleInputPassword1" for="inputSmall">Category::</label>
     <input  type="text"  class="form-control" name="category" value="<%=resultSet.getString("category")%>" disabled="disabled"/>
 
    </div>
    
    	
	<div class="form-group">
    <label for="exampleInputPassword1" for="inputSmall">Password::</label>
     <input  type="text" class="form-control" id="p_assword" name="admin_password" value="<%=decryptedString%>" disabled="disabled"/>
  </div>
